...
public class Scanner implements AutoCloseable {
    ...
    //чтение потока
    public Scanner(final InputStream inStream, String encoding) throws IOException {
        reader = new InputStreamReader(inStream, encoding);
        read = reader.read(buffer);
    }

    //чтение файла
    public Scanner(final File inFile, String encoding) throws IOException {
        reader = new InputStreamReader(new FileInputStream(inFile), encoding);
        read = reader.read(buffer);
    }

    //чтение строки
    public Scanner(final String str) throws IOException {
