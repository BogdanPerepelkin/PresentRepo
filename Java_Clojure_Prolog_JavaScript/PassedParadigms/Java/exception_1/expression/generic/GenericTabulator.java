...
public class GenericTabulator implements Tabulator {
    ...
    public static <E> Object[][][] genTabulate(NumberInterface<E> numberType, String inputExpression,
                                        int x1, int x2, int y1, int y2, int z1, int z2, boolean flag) {
        GenericParser<E> parser = new GenericParser<>(numberType);
        GenericExpression<E> expression = parser.parse(inputExpression);
